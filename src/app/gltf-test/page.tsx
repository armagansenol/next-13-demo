"use client"
import s from "./gltf-test.module.scss"
import "./gltf-test.scss"
...
function WatchSection({ className }: any) {
...
function WatchModel({ scale, inViewport, track, ...props }: any) {
  const ref = useRef<any>(null)
  const { nodes, materials }: any = useGLTF("/watch-v1.glb")
  ...
  const htmlPortal = useRef<any>(gl.domElement.parentNode)
